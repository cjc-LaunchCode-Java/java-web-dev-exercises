...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Strawberries", 1.00, new ArrayList<>(Arrays.asList("strawberry")));
        Topping topping2 = new Topping( "Caramel Sauce", 0.75, new ArrayList<>(Arrays.asList("dairy" )));
        Topping topping3 = new Topping("Chocolate Sauce", 1.50, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping4 = new Topping( "Peanuts", 2.00, new ArrayList<>(Arrays.asList("peanuts")));
    ...
    public String toStringCones() {
        String printout = "";
        for(Ingredient item: cones){
